        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs md:text-sm font-normal">
              ...
              <li>
                <a href="/about" className="hover:text-emerald-400 transition-colors duration-200">About Us</a>
              </li>
              <li>
                <a href="/contact" className="hover:text-emerald-400 transition-colors duration-200">Contact Portal</a>
              </li>
              <li>
                <a href="/careers" className="hover:text-emerald-400 transition-colors duration-200">Careers</a>
              </li>
              <li>
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs md:text-sm font-normal">
              <li>
                <a href="/properties" className="hover:text-emerald-400 transition-colors duration-200">Premium Projects</a>
              </li>
              <li>
                <a href="/loans" className="hover:text-emerald-400 transition-colors duration-200">Home Loan Tracking</a>
              </li>
              <li>
                <a href="/legal" className="hover:text-emerald-400 transition-colors duration-200">Legal Verification</a>
              </li>
              <li>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex items-center w-full max-w-sm mt-2">
              <input
                ...
                className="w-full bg-slate-800 text-xs text-white px-3 py-2 rounded-l border border-slate-700 focus:outline-none focus:border-emerald-500 placeholder-slate-500"
                required
              />
              <button
                type="submit"
                className="bg-emerald-700 text-white text-xs font-medium px-4 py-2 rounded-r hover:bg-emerald-600 transition-colors duration-200 shrink-0"
              >
                Join
              </button>
            </form>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 order-1 sm:order-2">
            ...
            <a
              href="#"
              aria-label="Facebook"
              className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-emerald-600 hover:text-white text-slate-400 transition-all duration-200"
            >
