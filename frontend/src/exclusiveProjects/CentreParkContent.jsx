        ...
        <div className="flex gap-6 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            <section id="overview" className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <div className="grid grid-cols-3 gap-y-5 mb-5">
                <div>
            ...
            <section id="floorplan" className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <div className="flex items-center gap-3 mt-4 flex-wrap">
                ...
                <button className="ml-auto text-xs text-blue-500 hover:underline flex items-center gap-1">
          ...
          <div className="w-[300px] shrink-0 sticky top-16 self-start">
