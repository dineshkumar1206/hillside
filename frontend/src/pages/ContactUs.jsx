    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16">
        ...
        <div className="max-w-3xl mb-12 md:mb-16">
          ...
          >
            Whether you are looking to buy a premium scenic plot, build a customized eco-villa, or query legal documents in Yelagiri Hills, our advisory desk is ready to help you.
          </motion.p>
        </div>
        ...
        <div className="grid lg:grid-cols-[380px_1fr] gap-10 items-start">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="bg-[#0E3A2F] text-white rounded-3xl p-6 md:p-8 shadow-xl space-y-8 relative overflow-hidden"
          >
            ...
            <div>
              ...
              <p className="text-emerald-200/80 text-sm">Expect a structured response callback within 2 business hours.</p>
            </div>

            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center shrink-0 mt-0.5">
                  <Phone size={18} className="text-[#7fff00]" />
                </div>
                <div>
                  <p className="text-xs text-emerald-250 uppercase tracking-wider font-semibold">Call Support Desk</p>
                  <p className="text-base font-medium mt-0.5">+91 22 4567 8900</p>
                  <p className="text-xs text-emerald-250/60">Toll-free inside India</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center shrink-0 mt-0.5">
                  <Mail size={18} className="text-[#7fff00]" />
                </div>
                <div>
                  <p className="text-xs text-emerald-250 uppercase tracking-wider font-semibold">Electronic Mail Desk</p>
                  <p className="text-base font-medium mt-0.5">hello@hillsite.com</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center shrink-0 mt-0.5">
                  <MapPin size={18} className="text-[#7fff00]" />
                </div>
                <div>
                  <p className="text-xs text-emerald-250 uppercase tracking-wider font-semibold">Corporate Office</p>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center shrink-0 mt-0.5">
                  <Clock size={18} className="text-[#7fff00]" />
                </div>
                <div>
                  <p className="text-xs text-emerald-250 uppercase tracking-wider font-semibold">Operating Business Hours</p>
                  <p className="text-sm font-medium mt-0.5">Monday – Saturday: 9:00 AM – 7:00 PM</p>
                  <p className="text-xs text-[#7fff00] font-semibold">Site visits open on Sundays</p>
                </div>
              </div>
            </div>

            <div className="border-t border-white/10 pt-6 flex items-center gap-2 text-xs text-emerald-250/70">
              <ShieldCheck size={16} className="text-[#7fff00] shrink-0" />
              ...
              {!submitSuccess ? (
                ...
                >
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        className="w-full text-sm border border-gray-300 rounded-xl px-4 py-3 text-gray-800 bg-white focus:outline-none focus:border-[#0E3A2F] transition-colors"
                      />
                    </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        ...
                        <option value="Scenic Valley Plots">Scenic Valley Plots (Yelagiri)</option>
                        <option value="Mountain View Heights">Mountain View Heights (Yelagiri)</option>
                        <option value="Eco Villa Retreats">Eco Villa Retreats (Yelagiri)</option>
                        <option value="Green Ridge Estate">Green Ridge Estate (Yelagiri)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea 
                      ...
                      className="w-full text-sm border border-gray-300 rounded-xl px-4 py-3 text-gray-800 bg-white focus:outline-none focus:border-[#0E3A2F] transition-colors resize-none"
                    />
                  </div>
                  ...
                  <div className="flex items-start gap-2.5 pt-1">
                    <input 
                      ...
                      onChange={handleInputChange}
                      className="w-4 h-4 text-[#0E3A2F] border-gray-300 rounded focus:ring-0 mt-0.5 accent-[#0E3A2F] cursor-pointer"
                    />
                    <label htmlFor="agreeToTerms" className="text-xs text-gray-500 leading-normal select-none cursor-pointer">
                      I hereby authorize Hillsite representatives to contact me via Call, SMS, or WhatsApp regarding my specific real-estate query. This supersedes any DND registries.
                    </label>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-[#0E3A2F] hover:bg-[#154e40] disabled:bg-gray-400 text-white font-semibold text-sm py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer shadow-md active:scale-[0.99]"
                  >
                    {isSubmitting ? (
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm max-w-sm mb-6 leading-relaxed">
                    Your hillside property inquiry has been successfully received. A local Yelagiri site-expert will contact you shortly.
                  </p>
                  <button
